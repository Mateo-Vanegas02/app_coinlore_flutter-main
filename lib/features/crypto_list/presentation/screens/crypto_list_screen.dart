...
import 'package:app_coinlore_flutter/features/crypto_charts/presentation/screens/crypto_charts_dashboard_screen.dart';
...
class _CryptoListScreenState extends ConsumerState<CryptoListScreen> {
            ...
            if (MediaQuery.of(context).size.width > 600) ...[
              ...
              _buildNavTab(
                ...
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => const CryptoChartsDashboardScreen(),
                  ),
                ),
              ),
  ...
  Widget _buildNavTab(String title, bool isDark, {VoidCallback? onTap}) {
    final text = Text(
      title,
      style: TextStyle(
        fontSize: 14,
